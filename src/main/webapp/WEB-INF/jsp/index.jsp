...
<link href="/cpws/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="/cpws/css/form.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="/cpws/js/jquery1.min.js"></script>
<link href="/cpws/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="/cpws/js/megamenu.js"></script>
<script>
...
<!--start slider -->
<link rel="stylesheet" href="/cpws/css/fwslider.css" media="all">
<script src="/cpws/js/jquery-ui.min.js"></script>
<script src="/cpws/js/css3-mediaqueries.js"></script>
<script src="/cpws/js/fwslider.js"></script>
<!--end slider -->
<script src="/cpws/js/jquery.easydropdown.js"></script>
...
<div class="header-top">
    <div class="wrap">
        ...
        <div class="cssmenu">
            <ul>
                <li class="active"><a href="login.html">我的账户</a></li> |
    ...
    <div class="wrap">
        <div class="section group">
            ...
            <div class="rsidebar span_1_of_left">
                ...
                <div class="border">
                    <link href="/cpws/css/default.css" rel="stylesheet" type="text/css" media="all" />
                    <link href="/cpws/css/nivo-slider.css" rel="stylesheet" type="text/css" media="all" />
                    <script src="/cpws/js/jquery.nivo.slider.js"></script>
